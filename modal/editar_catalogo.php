		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
            ...
            <label for="parametro" class="col-sm-3 control-label">Codigo Cuenta</label>
				<div class="col-sm-8">
				<input   title="Nombre del Parametro" type="text" class="form-control" id="codigo" name="codigo" placeholder="Codigo Cuenta" style="text-transform: uppercase;" onkeypress="return solonuemros(event)"  maxlength="25"  onPaste="return false;" onkeyup="return unespacio60()" required>
    ...
    function solonumeros(e){
       ...
       for(var i in especiales){
        ...
        if(letras.indexOf(tecla)==-1 && !tecla_especial){
			...
			<div class="col-sm-8">
			<input   title="Nombre del Parametro" type="text" class="form-control" id="cpa" name="cpa" placeholder="Codigo Cuenta Padre" style="text-transform: uppercase;" onkeypress="return solonumeros(event)"  maxlength="10"  onPaste="return false;" onkeyup="return unespacio60()" required>
...
<div class="form-group">	
            <label for="parametro" class="col-sm-3 control-label">Cuenta Padre</label>
				<div class="col-sm-8">
				<select title="sistema" class='form-control' name="desc" id="desc"  style="text-transform: uppercase;" >
					<option value="">- Seleccione una Cuenta -</option>

		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
            ...
            <label for="parametro" class="col-sm-3 control-label">Producto</label>
				<div class="col-sm-8">
				  <input   title="Nombre del Parametro" type="text" class="form-control" id="produc" name="produc" placeholder="Nombre Producto" style="text-transform: uppercase;" onkeypress="return soloLetras(event)"  maxlength="50"  onPaste="return false;" onkeyup="return unespacio60()" required> 
    ...
    function unespacio60(){
		orig=document.editar_usuario.produc.value; 
		nuev=orig.split('  ');
		nuev=nuev.join(' ');
		document.editar_usuario.produc.value=nuev;
...
<div class="form-group">	
            <label for="parametro" class="col-sm-3 control-label">Producto</label>
				<div class="col-sm-8">
				  <input   title="Nombre del Parametro" type="text" class="form-control" id="produc" name="produc" placeholder="Nombre Producto" style="text-transform: uppercase;" onkeypress="return soloLetras(event)"  maxlength="25"  onPaste="return false;" onkeyup="return unespacio60()" required> 
...
<div class="form-group">	
            <label for="parametro" class="col-sm-3 control-label">Precio</label>
				<div class="col-sm-8">
				  <input   title="Nombre del Parametro" type="text" class="form-control" id="pre" name="pre" placeholder="Precio Del Producto" style="text-transform: uppercase;" onkeypress="return solonumeros(event)"  maxlength="6"  onPaste="return false;" onkeyup="return unespacio60()" required> 

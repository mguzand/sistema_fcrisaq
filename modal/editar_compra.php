	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i> Editar Compras</h4>
		  </div>
		  <div class="modal-body">
            ...
            <label for="parametro" class="col-sm-3 control-label">Producto</label>
				<div class="col-sm-8">
				  <input   title="Nombre del Parametro" type="text" class="form-control" id="product" name="product" placeholder="Nombre Producto" style="text-transform: uppercase;" onkeypress="return soloLetras(event)"  maxlength="50"  onPaste="return false;" onkeyup="return unespacio60()" required> 
...
<div class="form-group">	
            <label for="parametro" class="col-sm-3 control-label">Precio</label>
				<div class="col-sm-8">
				  <input   title="Nombre del Parametro" type="text" class="form-control" id="prec" name="prec" placeholder="Precio Producto" style="text-transform: uppercase;" onkeypress="return solonumeros(event)"  maxlength="25"  onPaste="return false;" onkeyup="return unespacio60()" required> 
...
<div class="form-group">	
            <label for="parametro" class="col-sm-3 control-label">Cantidad</label>
				<div class="col-sm-8">
				  <input   title="Nombre del Parametro" type="text" class="form-control" id="cantidad" name="cantidad" placeholder="Cantidad Del Producto" style="text-transform: uppercase;" onkeypress="return solonumeros(event)"  maxlength="6"  onPaste="return false;" onkeyup="return unespacio60()" required> 
        ...
        if(letras.indexOf(tecla)==-1 && !tecla_especial){
            return false;
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				<select title="sistema" class='form-control' name="provee" id="provee"  style="text-transform: uppercase;" >

...
$row = $result->fetch_assoc();
	...
	$insertar=getPer('permiso_insercion',$rol,'20');

echo $insertar;
		$objeto="PANTALLA CATEGORIA";
		$accion="INGRESO A LA PANTALLA CATEGORIA";
		$descripcion="ingreso a pantalla Categoria";
	...
	<div class="contact-top">
		...
		<div class="panel-heading">
		    ...
		    <div class="btn-group pull-right">
				...
				<button type='button' class="btn btn-success" data-toggle="modal" data-target="#myModalpara"><span class="glyphicon glyphicon-plus" ></span> Nuevo Categoria</button>
			</div>

		<?php } ?>
			<h4><i class='glyphicon glyphicon-search'></i> Buscar Categoria</h4>
		</div>			
			...
			<?php
                ...
                include("modal/registro_categoria.php");
			...
			<form class="form-horizontal" role="form" id="datos_cotizacion">
                ...
                include("modal/eliminar_categoria.php");
 ...
 var parametros = $(this).serialize();
  ...
  event.preventDefault();
		...
		function load(page){
			...
			$("#loader").fadeIn('slow');
			$.ajax({
				url:'ajax/buscar_inventarios.php',
				 beforeSend: function(objeto){
		...
		function obtener_datos(id,para,valor,edad,eda){ 				
			$("#mod_id").val(id);
			$("#cate").val(para);
...
$('#bd-desde').on('change', function(){
		...
		var url = 'ajax/buscar_categoria_fecha.php';
		$.ajax({
		type:'POST',
		url:url,
...
function reportePDF(){
	var desde = $('#bd-desde').val();
	var hasta = $('#bd-hasta').val();
	window.open('reporte/recategoria.php?desde='+desde+'&hasta='+hasta);
}

...
//$insert=$res_per['permiso_insercion'];
	...
	$insertar=getPer('permiso_insercion',$rol,'14');
	$consultar=getPer('permiso_consulta',$rol,'14');

echo $insertar;
		$objeto="PANTALLA CATALOGO";
		$accion="INGRESO A LA PANTALLA CATALOGO";
		$descripcion="ingreso a pantalla Catalogo";
	...
	<div class="contact-top">
		...
		<?php } ?>
			...
			<?php
                ...
                include("modal/registro_catalogo.php");
			    include("modal/editar_catalogo.php");
			...
			<form class="form-horizontal" role="form" id="datos_cotizacion">
                ...
                include("modal/eliminar_catalogo.php");
...
$( "#editar_password" ).submit(function( event ) {
 ...
 var parametros = $(this).serialize();
	 $.ajax({
			type: "POST",
			url: "ajax/eliminar_catalogo.php",
			data: parametros,
...
$('#bd-desde').on('change', function(){
		...
		var url = 'ajax/buscar_catalogo_fecha.php';
		$.ajax({
		type:'POST',
		url:url,
...
function reportePDF(){
	var desde = $('#bd-desde').val();
	var hasta = $('#bd-hasta').val();
	window.open('reporte/recata.php?desde='+desde+'&hasta='+hasta);
}

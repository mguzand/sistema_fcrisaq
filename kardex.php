	...
	<div class="contact-top">
		...
		<?php } ?>
			...
			<?php
                ...
                include("modal/registro_kardex.php");
			    include("modal/editar_rekardex.php");
			...
			<form class="form-horizontal" role="form" id="datos_cotizacion">
                ...
                include("modal/eliminar_kardex.php");
...
$( "#editar_usuario" ).submit(function( event ) {
 ...
 var parametros = $(this).serialize();
  ...
  event.preventDefault();
		...
		function obtener_datos(id,equipo,exitencia,tipom){ 				
			$("#mod").val(id);
			$("#prd").val(equipo);
			$("#cant").val(existencia);
			$("#tp").val(tipom);	

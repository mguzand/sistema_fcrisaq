...
$( "#editar_usuario" ).submit(function( event ) {
 ...
 var parametros = $(this).serialize();
  ...
  event.preventDefault();
		...
		function obtener_datos(id,nom,liga){ 				
			$("#mod").val(id);
			$("#eq").val(nom);
			$("#lig").val(liga);
...
$('#bd-desde').on('change', function(){
		...
		var url = 'ajax/buscar_bita_fecha.php';
		$.ajax({
		type:'POST',
		url:url,
...
function reportePDF(){
	var desde = $('#bd-desde').val();
	var hasta = $('#bd-hasta').val();
	window.open('reporte/rebitacora.php?desde='+desde+'&hasta='+hasta);
}

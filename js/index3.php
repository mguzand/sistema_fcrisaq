						...
						<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								<ul class="nav navbar-nav">
									...
									<li class=""><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Registro<span class="caret"></span></a>
                                    ...
                                    <li class=""><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Historial Citas<span class="caret"></span></a>
										<ul class="dropdown-menu">
											<li><a class="hvr-bounce-to-bottom" href="programacion_citas.php">Programación Citas</a></li>
                                    ...
                                    <li class=""><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Servicios<span class="caret"></span></a>
										<ul class="dropdown-menu">
											<li><a class="hvr-bounce-to-bottom" href="listado_radio.php">Listado Radio Button</a></li>
											<li><a class="hvr-bounce-to-bottom" href="farmacia.php">Farmacia</a></li>
										</ul>
									</li>
                                    
                                    <li class=""><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Mantenimiento<span class="caret"></span></a>
										<ul class="dropdown-menu">
											<li><a class="hvr-bounce-to-bottom" href="mantenimiento_usuario.php">Mantenimiento Usuario</a></li>
											<li><a class="hvr-bounce-to-bottom" href="mantenimiento_mascotas.php">Mantenimiento Mascotas</a></li>
										</ul>
									</li>
                                    ...
                                    <li class=""><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Reportes<span class="caret"></span></a>
										<ul class="dropdown-menu">
											...
											<li><a class="hvr-bounce-to-bottom" href="clientes.php">Clientes</a></li>
                                            <li><a class="hvr-bounce-to-bottom" href="reportes.php">Reportes</a></li> 
										</ul>
									</li>
		...
		<div class="container">
			<div class="agileits-w3layouts-footer-grids">
				<div class="col-md-4 footer-left">
					<h3>
						<a href="index.php">Cat <span>Club</span></a>
					</h3>

...
//Archivo verifica que el usario que intenta acceder a la URL esta logueado
	...
	if (empty($_POST['parametro'])) {
		...
		$sql="INSERT INTO tbl_parametros (nombre,descripcion) VALUES ('$parametro','$valor')";
		$query_new_insert = mysqli_query($con,$sql);
			if ($query_new_insert){
				$messages[] = "Parametro ha sido ingresado satisfactoriamente.";

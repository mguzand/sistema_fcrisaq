			...
			$errors[] = "ID vacío";
			 ...
			 !empty($_POST['user_id_mod'])
                ...
                // PHP 5.3/5.4, by the password hashing compatibility library
                    ...
                    $sql = "DELETE  FROM tbl_proveedor WHERE ID_Proveedor='".$id_parametro."'";
                    $query = mysqli_query($mysqli,$sql);

                    // if user has been added successfully
		if ($query) {
						$bita=grabarBitacora($idUsuario,$objeto,$accion,$sql);
                        $messages[] = "El registro ha sido eliminada con éxito.";
                    } else {
                        $errors[] = "Lo sentimos , el registro no se puede eliminar porque tiene relaciones con otras tablas.";
                    }

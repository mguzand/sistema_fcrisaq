...
echo $insertar;
		...
		$accion="INGRESO A LA PANTALLA LIBRO DIARIO";
		$descripcion="ingreso a pantalla Libro Diario";
	...
	<div class="contact-top">
		...
		<?php } ?>
			...
			<?php
			    ...
			    include("modal/editar_diario.php");
...
//id,cuenta,tipo,des,mont
		function obtener_datos(id,desglose,cuentad,monto,cuentac,fecha_creacion){ 				
			$("#mod").val(id);
			$("#dcr").val(desglose); 
			$("#db").val(cuentad);
			$("#mon").val(monto);	
...
function reportePDF(){
	var desde = $('#bd-desde').val();
	var hasta = $('#bd-hasta').val();
	window.open('reporte/reldiario.php?desde='+desde+'&hasta='+hasta);
}

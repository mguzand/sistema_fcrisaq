...
$pdf->Cell(65, 8, '', 0);
$pdf->Cell(10, 8, 'Listado de Usuarios Registrados', 0);
$pdf->Ln(15);
$pdf->Cell(-4, 8, '', 0);
...
$pdf->SetFont('Arial', '', 8);
//CONSULTA
$productos = mysqli_query($mysqli,"SELECT id_usuario, nombre_usuario, usuario, rol, correo_electronico, estado_usuario,tbl_usuario.fecha_creacion FROM tbl_usuario inner join tbl_roles on tbl_usuario.id_rol = tbl_roles.id_rol WHERE tbl_usuario.fecha_creacion order by id_usuario ");
$item = 0;
$totaluni = 0;
$totaldis = 0;
while($productos2 = mysqli_fetch_array($productos)){
	...
	$pdf->Cell(35, 8, $productos2['rol'], 0);
	$pdf->Cell(48, 8, $productos2['correo_electronico'], 0);
    $pdf->Cell(20, 8, $productos2['estado_usuario'], 0);

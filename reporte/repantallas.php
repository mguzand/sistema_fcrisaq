...
$pdf->Cell(65, 8, '', 0);
$pdf->Cell(10, 8, 'Listado de Pantallas Registradas', 0);
$pdf->Ln(15);
$pdf->Cell(15, 8, '', 0);
...
$pdf->SetFont('Arial', '', 8);
//CONSULTA
$productos = mysqli_query($mysqli,"SELECT * FROM tbl_pantallas WHERE fecha_creacion BETWEEN '$desde' AND '$hasta' ");
$item = 0;
$totaluni = 0;
$totaldis = 0;
while($productos2 = mysqli_fetch_array($productos)){
	...
	$pdf->Cell(40, 8, $productos2['objeto'], 0);
	$pdf->Cell(90, 8, $productos2['descripcion'], 0);

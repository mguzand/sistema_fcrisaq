...
$pdf->Cell(38, 8, '', 0);
$pdf->Cell(10,8,'REGISTRO DE CATALOGO DE CUENTA DEL '.$verDesde.' AL'.$verHasta);
$pdf->ln(15);
$pdf->Cell(1, 8, '', 0);

$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(15, 8, 'No.', 1,0,'C');
$pdf->Cell(50, 8, 'TIPO CUENTA ', 1,0,'C');
$pdf->Cell(35, 8, 'CODIGO CUENTA', 1,0,'C');
...
$pdf->SetFont('Arial', '', 8);
//CONSULTA
$productos = mysqli_query($mysqli,"SELECT id_catalogo, tipo_cuenta, codigo_cuenta, cuenta_padre, 
...
while($productos2 = mysqli_fetch_array($productos)){
    ...
    $pdf->Cell(50, 8, $productos2['tipo_cuenta'], 0);
    $pdf->Cell(40, 8, $productos2['codigo_cuenta'], 0,0,'C');
	$pdf->Cell(60, 8, $productos2['descripcion'], 0);
